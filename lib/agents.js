...
// `--auto-approve true` (cline), `--allow-all-tools` (copilot),
...
const AGENTS = [
  ...
  { kind: "agy", name: "Antigravity CLI", exec: ["agy", "antigravity", "antigravity-cli"], yoloArgs: ["--dangerously-skip-permissions"] },
  ...
  { kind: "devin", name: "Devin CLI", exec: ["devin"], yoloArgs: ["--permission-mode", "yolo"] },
  { kind: "droid", name: "Droid", exec: ["droid"], yoloArgs: ["--skip-permissions-unsafe"] },
