...
// prompt. Most of the newer agent CLIs use `--yolo`; the exceptions below are
// their documented names. Pi has no tool-approval layer, Amp is already
// approval-free by default, and opencode's permissions default to allow — so
// none of the three accepts (or needs) an extra switch.
const AGENTS = [
  { kind: "claude", name: "Claude Code", exec: ["claude"], yoloArgs: ["--dangerously-skip-permissions"] },
  { kind: "codex", name: "Codex", exec: ["codex"], yoloArgs: ["--yolo"] },
  { kind: "pi", name: "pi", exec: ["pi"], yoloArgs: [] },
  { kind: "agy", name: "Antigravity CLI", exec: ["agy", "antigravity", "antigravity-cli"], yoloArgs: ["--yolo"] },
  { kind: "amp", name: "Amp", exec: ["amp"], yoloArgs: [] },
  { kind: "cline", name: "Cline", exec: ["cline"], yoloArgs: ["--auto-approve", "true"] },
  { kind: "copilot", name: "GitHub Copilot CLI", exec: ["copilot"], yoloArgs: ["--allow-all-tools"] },
  { kind: "cursor", name: "Cursor Agent CLI", exec: ["cursor-agent", "cursor"], yoloArgs: ["--yolo"] },
  { kind: "devin", name: "Devin CLI", exec: ["devin"], yoloArgs: ["--yolo"] },
  { kind: "droid", name: "Droid", exec: ["droid"], yoloArgs: ["--yolo"] },
  { kind: "gemini", name: "Gemini CLI (deprecated)", exec: ["gemini"], yoloArgs: ["--yolo"] },
  { kind: "grok", name: "Grok", exec: ["grok", "grok-build"], yoloArgs: ["--yolo"] },
  { kind: "hermes", name: "Hermes Agent", exec: ["hermes", "hermes-agent"], yoloArgs: ["--yolo"] },
  { kind: "kilo", name: "Kilo Code CLI", exec: ["kilo"], yoloArgs: ["--yolo"] },
  ...
  { kind: "mastracode", name: "MastraCode", exec: ["mastracode"], yoloArgs: ["--yolo"] },
  { kind: "omp", name: "OMP", exec: ["omp"], yoloArgs: ["--yolo"] },
  { kind: "opencode", name: "opencode", exec: ["opencode"], yoloArgs: [] },
  { kind: "qodercli", name: "Qoder CLI", exec: ["qodercli", "qoder"], yoloArgs: ["--yolo"] },
];
