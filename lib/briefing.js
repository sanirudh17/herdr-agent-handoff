...
2. Do not restart the task from earlier transcript history.
3. Do not redo completed work. Do not redo completed diagnosis or completed implementation.
4. Do not replay old transcript. Older diagnostic steps are historical and must not be replayed.
5. Inspect the current workspace before editing.
6. Preserve uncommitted work.
7. Continue from the current stopping point.
8. If the summary says the task is complete, confirm briefly and stop.
9. If work remains, proceed directly.
