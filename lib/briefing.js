...
2. Send a status message in bullets — **Objective** (what the task was), **Done** (what the previous agent completed), **Stopping point** (where things stand), **Next** (what remains, if anything) — closing with ready for your next instruction. Send it before anything else.
