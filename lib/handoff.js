...
async function run(opts) {
  ...
  //    read by the target from where its own agent put it. A missing record is
  //    waited out briefly (agents persist lazily), and the cwd-keyed recovery
  //    stores run when the native reference is unavailable.
  let session;
  try {
