...
//
// These identifiers are interpolated into the queries below rather than bound,
// because SQL parameters cannot stand in for table or column names. That is
// safe exactly because TABLES is a module-level constant: no outside input
// can reach the query string. The one runtime value, the session id, is always
// passed as a bound `?` parameter. If this table ever stops being constant,
// reintroduce identifier validation at that point.
const TABLES = [
