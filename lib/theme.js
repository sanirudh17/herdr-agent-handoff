...
const PALETTES = {
  ...
  catppuccin_latte: {
    accent: [30, 102, 245],
    panel_bg: [239, 241, 245],
    surface0: [204, 208, 218],
    surface_dim: [230, 233, 239],
  ...
  tokyo_night: {
    ...
    panel_bg: [26, 27, 38],
    surface0: [36, 40, 59],
    surface_dim: [26, 27, 38],
    overlay0: [86, 95, 137],
    overlay1: [105, 113, 150],
    text: [192, 202, 245],
    subtext0: [169, 177, 214],
  },
  tokyo_night_day: {
    accent: [46, 125, 233],
    panel_bg: [225, 226, 231],
    surface0: [196, 200, 218],
    surface_dim: [210, 211, 218],
    overlay0: [137, 144, 179],
    overlay1: [104, 112, 154],
    text: [55, 96, 191],
    subtext0: [97, 114, 176],
  },
  dracula: {
    ...
    panel_bg: [40, 42, 54],
    surface0: [68, 71, 90],
    surface_dim: [40, 42, 54],
    overlay0: [98, 114, 164],
    overlay1: [130, 140, 180],
    text: [248, 248, 242],
    subtext0: [210, 210, 220],
  },
  nord: {
    accent: [136, 192, 208],
    panel_bg: [46, 52, 64],
    surface0: [59, 66, 82],
    surface_dim: [46, 52, 64],
    overlay0: [76, 86, 106],
    overlay1: [100, 110, 130],
    text: [236, 239, 244],
  ...
  gruvbox: {
    ...
    panel_bg: [40, 40, 40],
    surface0: [60, 56, 54],
    surface_dim: [40, 40, 40],
    overlay0: [146, 131, 116],
    overlay1: [168, 153, 132],
    text: [235, 219, 178],
    subtext0: [213, 196, 161],
  },
  gruvbox_light: {
    accent: [7, 102, 120],
    panel_bg: [251, 241, 199],
    surface0: [235, 219, 178],
    surface_dim: [242, 229, 188],
    overlay0: [146, 131, 116],
    overlay1: [124, 111, 100],
    text: [60, 56, 54],
    subtext0: [80, 73, 69],
  },
  one_dark: {
    ...
    panel_bg: [40, 44, 52],
    surface0: [44, 49, 58],
    surface_dim: [40, 44, 52],
    overlay0: [92, 99, 112],
    overlay1: [115, 122, 135],
    text: [171, 178, 191],
    subtext0: [150, 156, 168],
  },
  one_light: {
    accent: [64, 120, 242],
    panel_bg: [250, 250, 250],
    surface0: [240, 240, 241],
    surface_dim: [245, 245, 246],
    overlay0: [160, 161, 167],
    overlay1: [104, 107, 119],
    text: [56, 58, 66],
    subtext0: [104, 107, 119],
  },
  solarized: {
    accent: [38, 139, 210],
    panel_bg: [0, 43, 54],
  ...
  solarized_light: {
    accent: [38, 139, 210],
    panel_bg: [253, 246, 227],
    surface0: [238, 232, 213],
    surface_dim: [238, 232, 213],
  ...
  kanagawa: {
    ...
    panel_bg: [31, 31, 40],
    surface0: [42, 42, 55],
    surface_dim: [31, 31, 40],
    overlay0: [114, 113, 105],
    overlay1: [135, 134, 125],
    text: [220, 215, 186],
    subtext0: [200, 195, 170],
  },
  kanagawa_lotus: {
    accent: [77, 105, 155],
    panel_bg: [242, 236, 188],
    surface0: [220, 213, 172],
    surface_dim: [213, 206, 163],
    overlay0: [160, 156, 172],
    overlay1: [138, 137, 128],
    text: [84, 84, 100],
    subtext0: [67, 67, 108],
  },
  rose_pine: {
    ...
    panel_bg: [25, 23, 36],
    surface0: [31, 29, 46],
    surface_dim: [25, 23, 36],
    overlay0: [110, 106, 134],
    overlay1: [144, 140, 170],
    text: [224, 222, 244],
    subtext0: [200, 197, 220],
  },
  rose_pine_dawn: {
    accent: [144, 122, 169],
    panel_bg: [250, 244, 237],
    surface0: [242, 233, 225],
    surface_dim: [242, 233, 225],
    overlay0: [152, 147, 165],
    overlay1: [121, 117, 147],
    text: [70, 66, 97],
    subtext0: [121, 117, 147],
  },
  vesper: {
    accent: [255, 199, 153],
    panel_bg: [26, 26, 26],
    surface0: [35, 35, 35],
    surface_dim: [16, 16, 16],
    overlay0: [92, 92, 92],
    overlay1: [126, 126, 126],
    text: [255, 255, 255],
    subtext0: [160, 160, 160],
  },
};
...
const THEME_ALIASES = {
  ...
  "tokyonight-day": "tokyo_night_day",
  dracula: "dracula",
  nord: "nord",
  gruvbox: "gruvbox",
  ...
  lotus: "kanagawa_lotus",
  "rose-pine": "rose_pine",
  rosepine: "rose_pine",
  "rose-pine-dawn": "rose_pine_dawn",
  "rosepine-dawn": "rose_pine_dawn",
  dawn: "rose_pine_dawn",
  vesper: "vesper",
};
...
function contrastFg(palette) {
  if (!palette.panelBg || palette.panelBg.kind === "reset")
...
function styles(theme) {
  ...
  return {
    ...
    activeTab: onAccent,
    // The focused row carries the accent across the full width, so the selection
    // reads as one solid block rather than a ragged fill that stops at the text.
    // The pointer gets a quieter surface fill, so hover and selection stay
    // distinguishable. surface_dim is unusable for either: in catppuccin it is
    // #1e1e2e against a #181825 panel, effectively invisible.
    activeTabHover: fg(contrastFg(p)) + bg(p.overlay1) + BOLD,
    hoverRow: fg(p.text) + bg(p.surface0) + BOLD,
